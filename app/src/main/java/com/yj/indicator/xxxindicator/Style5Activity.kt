...
import com.yj.indicator.library.MagicTextStyle
import com.yj.indicator.xxxindicator.adapter.TourismAdapter
import com.yj.indicator.xxxindicator.bean.TourismResponse
import kotlinx.android.synthetic.main.activity_style5.*

class Style5Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        indicator_view_inner.apply {
            viewPager=view_pager
            orientationStyle= LinearLayout.HORIZONTAL
            indicatorPosition= Gravity.CENTER_HORIZONTAL
            mIndicatorSpace= 2f
            mIndicatorSelectedTextSize= 26f
            mIndicatorUnselectedTextSize= 26f
            mIndicatorSelectedColor= Color.parseColor("#FFB6813A")
            mIndicatorUnselectedColor=  Color.parseColor("#FFB6813A")
            magicTextStyle=MagicTextStyle.INNER
        }
        indicator_view_outer.apply {
            viewPager=view_pager
            orientationStyle= LinearLayout.HORIZONTAL
            indicatorPosition= Gravity.CENTER_HORIZONTAL
            mIndicatorSpace= 2f
            mIndicatorSelectedTextSize= 18f
            mIndicatorUnselectedTextSize= 12f
            mIndicatorSelectedColor= Color.parseColor("#FF0077")
            mIndicatorUnselectedColor=  Color.parseColor("#353535")
            magicTextStyle=MagicTextStyle.OUTER
        }
        indicator_view_inner.start()
        indicator_view_outer.start()
