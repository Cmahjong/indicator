...
import kotlinx.android.synthetic.main.activity_style2.*
import java.util.ArrayList

class Style2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        indicator_view.apply {
            ...
            mIndicatorHeight= 5f
            mIndicatorWidth= 20f
            mIndicatorSelectedColor= Color.parseColor("#ffff00")
            mIndicatorUnselectedColor=  Color.parseColor("#ff70ff")
        }
